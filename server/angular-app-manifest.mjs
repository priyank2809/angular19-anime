...
export default {
  ...
  assets: {
    ...
    'cards/index.html': {size: 25715, hash: 'ba4a74fe354391cad1054c72d956c6c66ebbef8515fca1f79ee0020752f70f1a', text: () => import('./assets-chunks/cards_index_html.mjs').then(m => m.default)},
