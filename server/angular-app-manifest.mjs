...
export default {
  ...
  assets: {
    ...
    'cards/index.html': {size: 25715, hash: '74cf14bd575915f84a498185d505270f7df40d3dc8d8300df1c56625c44f419c', text: () => import('./assets-chunks/cards_index_html.mjs').then(m => m.default)},
