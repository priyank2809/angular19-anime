...
export default {
  ...
  assets: {
    ...
    'cards/index.html': {size: 25715, hash: '07a4f54ac62270eca2e00bf229697c2537b5d722a227ea07f3ec573e2fe35b6e', text: () => import('./assets-chunks/cards_index_html.mjs').then(m => m.default)},
